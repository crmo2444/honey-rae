...
export const EmployeeDetails = () => {
    ...
    return  <section className="employee">
                    ...
                    {employee.employeeTickets ? <footer className="employee__footer">Currently working on {employee?.employeeTickets?.length} tickets.</footer>
                    : <footer className="employee__footer">Currently working on 0 tickets.</footer>}
        </section>
}